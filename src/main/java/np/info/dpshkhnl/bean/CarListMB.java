...
import np.info.dpshkhnl.service.CarService;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                np.info.dpshkhnl.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? np.info.dpshkhnl.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? np.info.dpshkhnl.infra.model.SortOrder.DESCENDING
                            : np.info.dpshkhnl.infra.model.SortOrder.UNSORTED;
                }
