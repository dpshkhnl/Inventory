 ...
 * 
 * This is a utility class to convert a number in String (may contain decimal or not) into
 * its Hindu-Arabic number system's place value equivalent Words expression for both English and Nepali Language. 
 * This can be used in Java classes or in JasperReports.
 * for e.g. the number 4,38,57,87,08,96,59,60,260.00 is equivalient to AMT in Words : 
 * Four Shankha  Thirty Eight Padma  Fifty Seven Neel  Eighty Seven Kharab  Eight Arab  
 * Ninety Six Crore  Fifty Nine Lakh  Sixty Thousand  Two Hundred and Sixty  Rupees 00 Paisa Only.
 * <br>
 * For further assistance visit our official site :<br>
 * @see <a href="http://www.magnus.com.np">Magnus Consulting Grp.</a>
 * For assistance on further development of this Utility visit us at:<br>
...
public class JrUtils {
	...
	public static String toWordsMarks(String bigNumber)
	{
		System.out.println("zz.. unformatted input number is ="+bigNumber);
		String amtInWords="";
		/* The following commented block was first used as a part of this method.
		...
		return (amtInWords.equals(""))?"" :""+amtInWords.trim();
	}
